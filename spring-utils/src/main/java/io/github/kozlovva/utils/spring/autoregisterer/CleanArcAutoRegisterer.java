...
public class CleanArcAutoRegisterer implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware, PriorityOrdered {
    private ResourceLoader resourceLoader;
    private Environment environment;

    @Override
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        Map<String, Object> attrs = Objects.requireNonNull(metadata.getAnnotationAttributes(EnableCleanArcAutoRegisterer.class.getName()));
